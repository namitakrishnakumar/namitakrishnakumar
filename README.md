...
## What I work on
- Molecular docking & in silico drug screening (COPD, antimicrobials)
- NGS pipeline development
- RNA seq
- Bioinformatics data analysis and visualization

## Languages & Tools
-Python, R, Bash, Linux, PyRx, SwissADME, STRING, Cytoscape, BLAST
<!--
**namitakrishnakumar/namitakrishnakumar** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
